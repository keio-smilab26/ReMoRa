...
# Qwen3 specific template - optimized for video understanding
# Uses the same ChatML format but with a more specific system prompt
conv_qwen3 = Conversation(
    system="""<|im_start|>system
You are a helpful assistant that can analyze videos and images. Answer questions directly and concisely.""",
    roles=("<|im_start|>user", "<|im_start|>assistant"),
    version="qwen3",
    messages=[],
    offset=0,
...
# Qwen3 no-think template - forces direct answers without thinking
# Add empty thinking block to skip thinking phase
conv_qwen3_no_think = Conversation(
    system="""<|im_start|>system
You are a helpful assistant that can analyze videos and images. Answer questions directly and concisely.""",
    roles=("<|im_start|>user", "<|im_start|>assistant\n<think>\n</think>\n\n"),
    version="qwen3_no_think",
    messages=[],
    offset=0,
    sep_style=SeparatorStyle.CHATML,
    sep="<|im_end|>",
...
conv_templates = {
    ...
    "qwen_3": conv_qwen3,
    "qwen3": conv_qwen3,
    "qwen3_no_think": conv_qwen3_no_think,
