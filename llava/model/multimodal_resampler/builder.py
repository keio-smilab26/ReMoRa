...
# qformer.py imports legacy transformers internals (apply_chunking_to_forward)
# that were removed in transformers >= 4.50. Import is deferred to the
# qformer branch below so the rest of the resampler builder stays usable on
# modern transformers when the checkpoint isn't qformer-based.
