...
class Mamba(nn.Module):
    def __init__(
        ...
        if hasattr(self.dt_proj.bias, "ds_tensor"):
            # Multi-GPU: gather the partitioned bias before copying inv_dt in.
        ...
        # Our initialization would set all Linear.bias to zero; mark this one
        # as _no_reinit so it keeps the inv_dt values set above.
